...
function ShellColors(options) {
    // TODO enable replacement of colors by options-argument
    ...
    if (options.colorExtension) {
        copyColors(options.colorExtension, this.colors);
    }
